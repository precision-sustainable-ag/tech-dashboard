...
export const BannedRoleMessage = ({ title }) => {
  ...
  return (
    <Box component={Paper} elevation={1} p={2}>
      ...
      >
        <Grid item>
          <Typography variant={'h4'}>Your access level does not permit this action</Typography>
        </Grid>
        <Grid item>
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <path transform="translate(26)" d="M 0 6.98045 V 25.0195 H 4 V 6.98045 Z">
          <animate
            attributeName="d"
            values="M0 12 V20 H4 V12z; M0 4 V28 H4 V4z; M0 12 V20 H4 V12z; M0 12 V20 H4 V12z"
            dur="1.2s"
...
export const useInfiniteScroll = (callback = () => {}, hologramApiFunctional = true) => {
...
export const ScrollTop = (props) => {
  ...
  const handleBackToTopClick = (event) => {
    const anchor = (event.target.ownerDocument || document).querySelector('.topHead');
    console.log(anchor);
    if (anchor) {
...
export const YearsAndAffiliations = (props) => {
  const { title, years, affiliations, handleActiveAffiliation, handleActiveYear, showYears } =
    props;
